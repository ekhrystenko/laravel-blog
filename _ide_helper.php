...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function getResult($t = 0)
        {
                        /** @var \App\Http\Helpers\MySuperHelper $instance */
                        return $instance->getResult($t);
        }
...
namespace  { 
            ...
            class mySuperFacade extends \App\Http\Facades\MySuperFacade {}
